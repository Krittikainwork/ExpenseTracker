...
namespace ExpenseTrackerAPI.Services
{
  public class BudgetService : IBudgetService
  {
      ...
      string setByRole, string callerUserId, bool callerIsAdmin, CancellationToken ct)
    {
      ...
      {
        // ✅ Allow any Manager/Admin to top up (no creator conflict)
      ...
      string setByRole, string callerUserId, bool callerIsAdmin, CancellationToken ct)
    {
      ...
      // ✅ Allow any Manager/Admin to clear (no creator conflict)
      ...
      string setByRole, string callerUserId, bool callerIsAdmin, CancellationToken ct)
    {
      ...
      // ✅ Allow any Manager/Admin to clear month (no creator conflict)
